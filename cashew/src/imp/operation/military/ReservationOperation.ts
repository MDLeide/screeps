...
export class ReservationOperation extends JobOperation {
    ...
    public save(): ReservationOperationMemory {
        let mem = super.save() as ReservationOperationMemory;
        mem.roomName = this.roomName;
        mem.distance = this.distance;
        mem.targetReservation = this.targetReservation;
        return mem;
    }
}
